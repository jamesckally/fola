...
const StableCoinPage = () => {
    ...
    const usdValue = balance * 1.0; // $1.000 per SBC
                ...
                <Card className="p-6 bg-gradient-to-br from-[#00ff9d]/20 via-[#00d9ff]/20 to-purple-500/20 border-none shadow-xl rounded-3xl mb-6 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-foreground">Stable Coin</h1>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <Button
                                disabled
                                className="bg-gradient-to-r from-[#00ff9d] to-[#00d9ff] text-black font-bold shadow-lg hover:shadow-[#00ff9d]/20 hover:scale-105 transition-all duration-300 rounded-xl h-12 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
